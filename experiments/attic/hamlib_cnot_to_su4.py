...
from phoenix.primitive.utils import unroll_su4, _normalize_canonical_coordinates, fuse_neighbor_u3
...
for fname in natsorted(os.listdir(cnot_dpath)):
    ...
    phoenix.utils.print_circ_info(circ, title="CNOT ISA circuit")
    phoenix.utils.print_circ_info(circ_su4, title="SU(4) ISA circuit")
