...
def main():
    ...
    parser.add_argument("-d", "--device", type=str, help="Device topology (options: hhex, square)")
    ...
    with ProcessPoolExecutor(max_workers=args.jobs) as executor:
        futures = {executor.submit(process_one, src, dst, args.device): (src, dst) for src, dst in tasks}
